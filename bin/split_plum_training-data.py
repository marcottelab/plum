...
pos_ids = np.unique(np.array( list(map(tuple,pos[["ID1","ID2"]].values)), dtype='U25,U25' ))
neg_ids = np.unique(np.array( list(map(tuple,neg[["ID1","ID2"]].values)), dtype='U25,U25' ))
